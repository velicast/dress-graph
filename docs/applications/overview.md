...
DRESS is a **single algorithm** that attacks problems normally requiring
...
- [**Graph Classification**](classification.md): whole-graph classification via a 24-dimensional DRESS fingerprint
- [**Graph Retrieval**](retrieval.md): structural similarity search using an 84-dimensional DRESS fingerprint
- [**GED Regression**](ged-regression.md): predicting Graph Edit Distance from DRESS fingerprint pairs
- [**Edge Robustness**](edge-robustness.md): DRESS edge values provide a strong static edge-importance ranking, capturing a significant portion of adaptive betweenness at a fraction of the cost
