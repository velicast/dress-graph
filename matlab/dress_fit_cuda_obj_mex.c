/*
 * dress_fit_cuda_obj_mex.c — MEX gateway: CUDA fit on a persistent DRESS graph.
 *
 * Usage:
 *   result = dress_fit_cuda_obj_mex(ptr, max_iterations, epsilon)
 *
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 3)
        mexErrMsgIdAndTxt("dress:nrhs",
            "Three inputs required: dress_fit_cuda_obj_mex(ptr, max_iterations, epsilon)");
