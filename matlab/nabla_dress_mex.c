 ...
 *       nabla_dress_mex.c ../libdress/src/dress.c ../libdress/src/delta_dress.c -lm
 *
 * Usage in MATLAB:
 *
 *   result = nabla_dress_mex(n_vertices, sources, targets, ...
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    hist = dress_nabla_fit(g, k, max_iterations, epsilon,
                    n_samples, seed,
                    compute_hist ? &hist_size : NULL,
                    keep_ms,
                    keep_ms ? &ms_ptr : NULL,
                    keep_ms ? &num_tup : NULL);
