/*
 * dress_omp_mex.c — MATLAB MEX gateway for the DRESS C library.
 *
 ...
 *       dress_omp_mex.c ../libdress/src/dress.c -lm
 *
 * Or, if dress.o is already built:
 *
 *   mex -O -I../libdress/include CFLAGS="$CFLAGS -fopenmp" LDFLAGS="$LDFLAGS -fopenmp" ...
 *       dress_omp_mex.c ../dress.o -lm
 *
 * Usage in MATLAB:
 *
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 8)
        mexErrMsgIdAndTxt("dress:nrhs",
            ...
            "  dress_omp_mex(n_vertices, sources, targets, weights, "
            "variant, max_iterations, epsilon, precompute)");
    if (nlhs > 1)
