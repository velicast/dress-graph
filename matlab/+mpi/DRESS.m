...
%     g.close();
    ...
    methods
        ...
        %
        %  Requires MPI MEX support.  Build delta_dress_mpi_mex first.
            error('mpi:notBuilt', ...
                  'MPI delta_fit requires delta_dress_mpi_mex. Build with MPI support first.');
        end
