...
% MPI.DELTA_DRESS_FIT  MPI-distributed Delta-k-DRESS exact histogram.
%
%   result = mpi.delta_fit(n_vertices, sources, targets)
%   result = mpi.delta_fit(n_vertices, sources, targets, Name, Value, ...)
%
...
%     r = mpi.delta_fit(4, sources, targets, 'K', 1);
%
%   Required inputs:
...
%
%   See also: delta_fit, mpi.DRESS, delta_dress_mpi_mex
    ...
    result = delta_dress_mpi_mex(n_vertices, sources, targets, weights, k, ...
