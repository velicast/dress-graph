...
mex('-O', ...
    ...
    fullfile('..', 'libdress', 'src', 'dress_histogram.c'), ...
    '-lm');
...
% OMP MEX files
omp_src = fullfile('..', 'libdress', 'src', 'omp');

fprintf('Compiling dress_omp_mex ...\n');
mex('-O', inc_flag, omp_c, omp_ld, ...
    'dress_omp_mex.c', dress_src, ...
    fullfile(omp_src, 'dress_omp.c'), ...
    '-lm');
fprintf('Done. dress_omp_mex.%s is ready.\n', mexext);

fprintf('Compiling delta_dress_omp_mex ...\n');
mex('-O', inc_flag, omp_c, omp_ld, ...
    'delta_dress_omp_mex.c', dress_src, ...
    fullfile('..', 'libdress', 'src', 'delta_dress.c'), ...
    fullfile('..', 'libdress', 'src', 'dress_histogram.c'), ...
    fullfile(omp_src, 'dress_omp.c'), ...
    fullfile(omp_src, 'delta_dress_omp.c'), ...
    '-lm');
fprintf('Done. delta_dress_omp_mex.%s is ready.\n', mexext);
