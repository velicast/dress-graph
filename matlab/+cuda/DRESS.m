...
% CUDA.DRESS  Persistent CUDA-accelerated DRESS graph object.
%
%   g = cuda.DRESS(n_vertices, sources, targets)
%   g = cuda.DRESS(n_vertices, sources, targets, 'Weights', w, ...)
%
%   Methods:
...
%
%   Example:
%     g = cuda.DRESS(4, int32([0;1;2;2]), int32([1;2;0;3]));
%     g.fit();
%     d = g.get(0, 3);
%     disp(d);
%     g.close();
