...
% CUDA.DELTA_DRESS_FIT  GPU-accelerated Delta-k-DRESS exact histogram.
%
%   result = cuda.delta_fit(n_vertices, sources, targets)
%   result = cuda.delta_fit(n_vertices, sources, targets, Name, Value, ...)
%
...
%     r = cuda.delta_fit(4, sources, targets, 'K', 1);
%
%   See also: delta_fit, delta_dress_cuda_mex
