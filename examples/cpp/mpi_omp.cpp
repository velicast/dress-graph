// mpi_omp.cpp — Rook vs Shrikhande with Δ¹-DRESS (MPI + OpenMP, C++ wrapper)
// Keeps multisets and compares them to guarantee distinguishability.
//
// Build & run:
//   mpicxx -O2 -std=c++17 -fopenmp -o mpi_omp mpi_omp.cpp -ldress -lm
//   mpirun -np 4 ./mpi_omp
#include <iostream>
#include <vector>
#include <algorithm>
...
int main(int argc, char **argv) {
    ...
    mpi::omp::DRESS rook(16, rook_s, rook_t);
    mpi::omp::DRESS shri(16, shri_s, shri_t);
