# mpi.R — Rook vs Shrikhande with Δ¹-DRESS (MPI, CPU backend)
...
dr <- mpi$delta_dress_fit(16L, rook_s, rook_t, k = 1L, keep_multisets = TRUE)
ds <- mpi$delta_dress_fit(16L, shri_s, shri_t, k = 1L, keep_multisets = TRUE)
