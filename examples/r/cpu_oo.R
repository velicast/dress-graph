# cpu_oo.R — Prism vs K₃,₃ with DRESS (CPU, OO API)
#
...
prism <- DRESS(6L, prism_s, prism_t)
k33   <- DRESS(6L, k33_s, k33_t)
...
vp <- prism$get(0L, 4L)   # 0-4 not in prism
vk <- k33$get(0L, 1L)     # 0-1 not in K₃,₃
