#!/usr/bin/env python3
"""mpi_oo.py — Rook vs Shrikhande with Δ¹-DRESS (MPI, OO API)
...
rook = DRESS(16, rook_s, rook_t)
shri = DRESS(16, shri_s, shri_t)
...
dr = rook.delta_fit(k=1, keep_multisets=True)
