# mpi_oo.jl — Rook vs Shrikhande with Δ¹-DRESS (MPI, OO API)
#
# Demonstrates the persistent DressGraph object with MPI-distributed delta_fit.
# Both are SRG(16,6,2,2) — indistinguishable by Δ⁰-DRESS.
# Δ¹-DRESS (k=1) separates them.
#
# Run:
#   mpirun -np 4 julia mpi_oo.jl
using MPI
MPI.Init()

using DRESS.MPI: DressGraph, fit!, delta_fit!, close!
