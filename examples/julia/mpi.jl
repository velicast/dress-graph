# mpi.jl — Rook vs Shrikhande with Δ¹-DRESS (MPI, CPU backend)
# Keeps multisets and compares them to guarantee distinguishability.
#
# Run:
#   mpirun -np 4 julia mpi.jl
using MPI
MPI.Init()

using DRESS.MPI: delta_dress_fit
...
dr = delta_dress_fit(16, rook_s, rook_t; k=1, keep_multisets=true)
ds = delta_dress_fit(16, shri_s, shri_t; k=1, keep_multisets=true)
