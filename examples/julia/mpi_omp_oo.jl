# mpi_omp_oo.jl — Rook vs Shrikhande with Δ¹-DRESS (MPI + OpenMP, OO API)
#
# Demonstrates the persistent DressGraph object with GPU fitting and
# MPI-distributed delta_fit.
#
# Run:
#   mpirun -np 4 julia mpi_omp_oo.jl
using MPI
MPI.Init()

using DRESS.MPI.OMP: DressGraph, fit!, delta_fit!, close!
