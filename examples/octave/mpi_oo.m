% mpi_oo.m — Rook vs Shrikhande with Δ¹-DRESS (MPI, OO API, Octave)
%
% Demonstrates the persistent DRESS object with MPI-distributed delta_fit.
% NOTE: Requires MPI MEX support in the installed Octave package.
%
% Run:
%   mpirun -np 4 octave --no-gui --eval "run('mpi_oo.m')"
...
rook = mpi.DRESS(16, rook_s, rook_t);
shri = mpi.DRESS(16, shri_s, shri_t);
