% mpi_cuda_oo.m — Rook vs Shrikhande with Δ¹-DRESS (MPI + CUDA, OO API, Octave)
%
% Demonstrates the persistent DRESS object with GPU fitting and
% MPI-distributed delta_fit.
% NOTE: Requires MPI+CUDA MEX support in the installed Octave package.
%
% Run:
%   mpirun -np 4 octave --no-gui --eval "run('mpi_cuda_oo.m')"
