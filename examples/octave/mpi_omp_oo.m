% mpi_omp_oo.m — Rook vs Shrikhande with Δ¹-DRESS (MPI + OpenMP, OO API, Octave)
%
% Demonstrates the persistent DRESS object with GPU fitting and
% MPI-distributed delta_fit.
% NOTE: Requires MPI+OpenMP MEX support in the installed Octave package.
%
% Run:
%   mpirun -np 4 octave --no-gui --eval "run('mpi_omp_oo.m')"
...
rook = mpi.omp.DRESS(16, rook_s, rook_t);
shri = mpi.omp.DRESS(16, shri_s, shri_t);
