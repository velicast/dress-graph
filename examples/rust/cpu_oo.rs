...
fn main() {
    ...
    let mut prism = DRESS::new(6, prism_s, prism_t, None, None, Variant::Undirected, false).unwrap();

    let mut k33 = DRESS::new(6, k33_s, k33_t, None, None, Variant::Undirected, false).unwrap();
