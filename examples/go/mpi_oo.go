// mpi_oo.go — Rook vs Shrikhande with Δ¹-DRESS (MPI, OO API)
//
// Demonstrates the persistent DRESS object with MPI-distributed DeltaFit.
//
// Run:
//
//	mpirun -np 4 go run mpi_oo.go
package main
