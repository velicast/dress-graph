% cuda_oo.m — Prism vs K₃,₃ with DRESS (CUDA, OO API)
%
% Demonstrates the persistent DRESS object with GPU-accelerated fitting.
%
% Run:
%   matlab -batch "run('cuda_oo.m')"
...
% Construct persistent graph objects (CUDA-accelerated)
prism = cuda.DRESS(6, prism_s, prism_t);
k33   = cuda.DRESS(6, k33_s, k33_t);
