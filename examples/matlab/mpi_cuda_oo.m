% mpi_cuda_oo.m — Rook vs Shrikhande with Δ¹-DRESS (MPI + CUDA, OO API)
%
% Demonstrates the persistent DRESS object with GPU fitting and
% MPI-distributed delta_fit.
% NOTE: Requires MPI MEX support — build delta_dress_mpi_cuda_mex first.
%
% Run:
%   mpirun -np 4 matlab -batch "run('mpi_cuda_oo.m')"
...
% Construct persistent graph objects (MPI+CUDA)
rook = mpi.cuda.DRESS(16, rook_s, rook_t);
shri = mpi.cuda.DRESS(16, shri_s, shri_t);
