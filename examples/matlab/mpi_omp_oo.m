% mpi_omp_oo.m — Rook vs Shrikhande with Δ¹-DRESS (MPI + OpenMP, OO API)
%
% Demonstrates the persistent DRESS object with GPU fitting and
% MPI-distributed delta_fit.
% NOTE: Requires MPI MEX support — build delta_dress_mpi_omp_mex first.
%
% Run:
%   mpirun -np 4 matlab -batch "run('mpi_omp_oo.m')"
